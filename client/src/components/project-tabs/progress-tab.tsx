...
export default function ProgressTab({ project, onEditRoad, onAddRoad, onAddProgress, onResetProgress }: ProgressTabProps) {
  ...
  return (
    <div className="space-y-6">
      {/* Activities Table - Shows for ALL project types */}
      <Card>
        <CardHeader>
                  ...
                  <TableRow key={activity.id} data-testid={`activity-row-${activity.id}`}>
                    ...
                    <TableCell>
                      <div className="flex items-center gap-3">
                        ...
                        <span className="text-sm font-medium w-12 text-right" data-testid={`activity-progress-${activity.id}`}>
                          {activity.progress}%
                        </span>
                      </div>
                    </TableCell>
      ...
      {/* Road Construction Details - Only for Road projects */}
      {project.projectType === "Road" && (
        <>
          <Separator className="my-6" />
          <div>
            <h3 className="text-xl font-semibold mb-4" data-testid="heading-road-details">
